...
def project3Dto2D(P,S,Q,point):
    ...
    scaled_x = map_range(mapped_coord[0],[147, 0], [-256,256])  #scaled_x = map_range(mapped_coord[0],[0, 115], [-512,512]) *-1  #(flipping of X coordinates.) ### scaled_x = map_range(mapped_coord[0],[0, 158], [-512,512]) *-1
    scaled_y = map_range(mapped_coord[1], [0, 147], [-256, 256]) # #scaled_y = map_range(mapped_coord[1], [0, 115], [-512, 512]) #scaled_y = map_range(mapped_coord[1], [0, 200], [-512, 512])
